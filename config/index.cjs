...
const USER_CONFIG = {
  ...
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'e1b29ae7466af2ba77bb007b35057cab',
  ...
  USERS: [
    {
      ...
      id: 'oYosX6unOFm9SSQsPvulItnqKZZ4',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'FMWBKl5FoqErbPkAhPiBv-oaTeabbDW4qKhBLbOwTSs',
      // 所在省份
      province: '云南',
      // 所在城市
      city: '昭通',
    ...
    },
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'y7764fAZkfoFY6gLP-ILAZAuTFGxF_TYwBf14wv6m7A',
      // 所在省份
      province: '北京',
      // 所在城市
      city: '北京',
    ...
    },
    {
      ...
      useTemplateId: 'sIHTkSQVPlBF6qnSMgPIEsp9BNWDCzJSLEYLZR4WwmI',
      // 所在省份
      province: '北京',
      // 所在城市
      city: '北京',
